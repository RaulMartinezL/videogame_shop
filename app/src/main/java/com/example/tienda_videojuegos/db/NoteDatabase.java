...
public class NoteDatabase extends SQLiteOpenHelper {
    ...
    private static void addVideogame(SQLiteDatabase db, String name, String description, int price,
    ...
    private void loadDatabase(SQLiteDatabase db, Context context) {
        ...
        try {
            ...
            for (int i = 0; i < m_jArray.length(); i++) {
                ...
                addVideogame(db, game_name, game_description, Integer.parseInt(game_price),
